...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Home', path: '/', icon: Wind },
    { name: 'Dashboard', path: '/city-selector', icon: LayoutDashboard },
    { name: 'Tree Impact', path: '/tree-impact', icon: Trees },
    { name: 'Wildlife', path: '/wildlife', icon: Bird },
    { name: 'Chatbot', path: '/chatbot', icon: MessageCircle },
    { name: 'Green Tips', path: '/green-suggestions', icon: Lightbulb },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-xl hover:bg-indigo-50 transition-colors"
          >
