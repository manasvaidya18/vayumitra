...
export const getHealthRiskData = (age, conditions) => {
  ...
  return {
    ...
    color: totalRisk > 70 ? '#ef4444' : totalRisk > 40 ? '#f59e0b' : '#22c55e',
    recommendations: [
      totalRisk > 70 ? 'Avoid outdoor activities during peak hours' : 'Moderate outdoor activities recommended',
...
export const getShockPredictorData = () => ({
  alerts: [
    {
      id: 1,
      type: 'warning',
...
export const getTreeImpactData = () => ({
  currentAQI: 87,
  projectedAQI: 65,
  treesNeeded: 250,
